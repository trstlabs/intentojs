...
const balance = await client.cosmos.bank.v1beta1
    .allBalances({ address: 'trst1addresshere' });

// you can also query the trst modules
const balances = await client.trst.exchange.v1beta1
    .exchangeBalances()
```
...
```js
import { getSigningtrstClient } from 'trustlessjs';

const stargateClient = await getSigningtrstClient({
  rpcEndpoint,
