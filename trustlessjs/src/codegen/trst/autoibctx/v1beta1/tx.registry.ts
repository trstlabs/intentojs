...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/trst.autoibctx.v1beta1.MsgRegisterAccount", MsgRegisterAccount], ["/trst.autoibctx.v1beta1.MsgSubmitTx", MsgSubmitTx], ["/trst.autoibctx.v1beta1.MsgSubmitAutoTx", MsgSubmitAutoTx], ["/trst.autoibctx.v1beta1.MsgRegisterAccountAndSubmitAutoTx", MsgRegisterAccountAndSubmitAutoTx], ["/trst.autoibctx.v1beta1.MsgUpdateAutoTx", MsgUpdateAutoTx]];
