...
const _196 = __importStar(require("./applications/transfer/v1/tx.amino"));
const _197 = __importStar(require("./core/channel/v1/tx.amino"));
const _198 = __importStar(require("./core/client/v1/tx.amino"));
const _199 = __importStar(require("./core/connection/v1/tx.amino"));
const _200 = __importStar(require("./applications/transfer/v1/tx.registry"));
const _201 = __importStar(require("./core/channel/v1/tx.registry"));
const _202 = __importStar(require("./core/client/v1/tx.registry"));
const _203 = __importStar(require("./core/connection/v1/tx.registry"));
const _204 = __importStar(require("./applications/transfer/v1/query.rpc.Query"));
const _205 = __importStar(require("./core/channel/v1/query.rpc.Query"));
const _206 = __importStar(require("./core/client/v1/query.rpc.Query"));
const _207 = __importStar(require("./core/connection/v1/query.rpc.Query"));
const _208 = __importStar(require("./applications/transfer/v1/tx.rpc.msg"));
const _209 = __importStar(require("./core/channel/v1/tx.rpc.msg"));
const _210 = __importStar(require("./core/client/v1/tx.rpc.msg"));
const _211 = __importStar(require("./core/connection/v1/tx.rpc.msg"));
const _264 = __importStar(require("./rpc.query"));
const _265 = __importStar(require("./rpc.tx"));
var ibc;
(function (ibc) {
    let applications;
