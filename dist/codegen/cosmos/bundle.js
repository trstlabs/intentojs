...
const _121 = __importStar(require("./staking/v1beta1/tx.amino"));
const _122 = __importStar(require("./upgrade/v1beta1/tx.amino"));
const _123 = __importStar(require("./authz/v1beta1/tx.registry"));
const _124 = __importStar(require("./bank/v1beta1/tx.registry"));
const _125 = __importStar(require("./distribution/v1beta1/tx.registry"));
const _126 = __importStar(require("./gov/v1beta1/tx.registry"));
const _127 = __importStar(require("./staking/v1beta1/tx.registry"));
const _128 = __importStar(require("./upgrade/v1beta1/tx.registry"));
const _129 = __importStar(require("./auth/v1beta1/query.rpc.Query"));
const _130 = __importStar(require("./authz/v1beta1/query.rpc.Query"));
const _131 = __importStar(require("./bank/v1beta1/query.rpc.Query"));
const _132 = __importStar(require("./distribution/v1beta1/query.rpc.Query"));
const _133 = __importStar(require("./gov/v1beta1/query.rpc.Query"));
const _134 = __importStar(require("./staking/v1beta1/query.rpc.Query"));
const _135 = __importStar(require("./tx/v1beta1/service.rpc.Service"));
const _136 = __importStar(require("./upgrade/v1beta1/query.rpc.Query"));
const _137 = __importStar(require("./authz/v1beta1/tx.rpc.msg"));
const _138 = __importStar(require("./bank/v1beta1/tx.rpc.msg"));
const _139 = __importStar(require("./distribution/v1beta1/tx.rpc.msg"));
const _140 = __importStar(require("./gov/v1beta1/tx.rpc.msg"));
const _141 = __importStar(require("./staking/v1beta1/tx.rpc.msg"));
const _142 = __importStar(require("./upgrade/v1beta1/tx.rpc.msg"));
const _182 = __importStar(require("./rpc.query"));
const _183 = __importStar(require("./rpc.tx"));
var cosmos;
(function (cosmos) {
    let auth;
    (function (auth) {
