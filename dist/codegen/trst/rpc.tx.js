...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    trst: {
        autoibctx: {
            v1beta1: new (await Promise.resolve().then(() => __importStar(require("./autoibctx/v1beta1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        claim: {
            v1beta1: new (await Promise.resolve().then(() => __importStar(require("./claim/v1beta1/claim.rpc.msg")))).MsgClientImpl(rpc)
        }
    }
});
