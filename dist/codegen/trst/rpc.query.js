...
const createRPCQueryClient = async ({ rpcEndpoint }) => {
    ...
    return {
        ...
        trst: {
            alloc: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./alloc/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            autoibctx: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./autoibctx/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            claim: {
                v1beta1: (await Promise.resolve().then(() => __importStar(require("./claim/v1beta1/query.rpc.Query")))).createRpcQueryExtension(client)
            },
            mint: {
