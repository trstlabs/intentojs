...
const createLCDClient = async ({ restEndpoint }) => {
    ...
    return {
        ...
        trst: {
            alloc: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./alloc/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            autoibctx: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./autoibctx/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            claim: {
                v1beta1: new (await Promise.resolve().then(() => __importStar(require("./claim/v1beta1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            mint: {
