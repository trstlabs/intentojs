...
export const intentoProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...intentoClaimV1beta1ClaimRegistry.registry, ...intentoIntentV1beta1TxRegistry.registry];
