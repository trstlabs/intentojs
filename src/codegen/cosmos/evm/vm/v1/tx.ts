...
export const MsgEthereumTx = {
  ...
  isSDK(o: any): o is MsgEthereumTxSDKType {
    return o && (o.$typeUrl === MsgEthereumTx.typeUrl || typeof o.size === "number" && typeof o.hash === "string" && typeof o.from === "string");
  },
...
export const LegacyTx = {
  ...
  isSDK(o: any): o is LegacyTxSDKType {
...
export const AccessListTx = {
  ...
  isSDK(o: any): o is AccessListTxSDKType {
    return o && (o.$typeUrl === AccessListTx.typeUrl || typeof o.chain_id === "string" && typeof o.nonce === "bigint" && typeof o.gas_price === "string" && typeof o.gas === "bigint" && typeof o.to === "string" && typeof o.value === "string" && (o.data instanceof Uint8Array || typeof o.data === "string") && Array.isArray(o.accesses) && (!o.accesses.length || AccessTuple.isSDK(o.accesses[0])) && (o.v instanceof Uint8Array || typeof o.v === "string") && (o.r instanceof Uint8Array || typeof o.r === "string") && (o.s instanceof Uint8Array || typeof o.s === "string"));
  },
...
export const DynamicFeeTx = {
  ...
  isSDK(o: any): o is DynamicFeeTxSDKType {
...
export const ExtensionOptionsEthereumTx = {
  ...
  isSDK(o: any): o is ExtensionOptionsEthereumTxSDKType {
    return o && o.$typeUrl === ExtensionOptionsEthereumTx.typeUrl;
  },
...
GlobalDecoderRegistry.registerAminoProtoMapping(ExtensionOptionsEthereumTx.aminoType, ExtensionOptionsEthereumTx.typeUrl);
...
export const MsgEthereumTxResponse = {
  ...
  isSDK(o: any): o is MsgEthereumTxResponseSDKType {
    return o && (o.$typeUrl === MsgEthereumTxResponse.typeUrl || typeof o.hash === "string" && Array.isArray(o.logs) && (!o.logs.length || Log.isSDK(o.logs[0])) && (o.ret instanceof Uint8Array || typeof o.ret === "string") && typeof o.vm_error === "string" && typeof o.gas_used === "bigint");
  },
...
GlobalDecoderRegistry.registerAminoProtoMapping(MsgEthereumTxResponse.aminoType, MsgEthereumTxResponse.typeUrl);
