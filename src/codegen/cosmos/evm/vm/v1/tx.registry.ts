...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/cosmos.evm.vm.v1.MsgEthereumTx", MsgEthereumTx], ["/cosmos.evm.vm.v1.MsgUpdateParams", MsgUpdateParams]];
