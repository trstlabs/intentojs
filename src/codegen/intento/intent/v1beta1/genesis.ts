...
export interface GenesisStateProtoMsg {
  typeUrl: "/intento.intent.v1beta1.GenesisState";
  value: Uint8Array;
}
/** GenesisState - genesis state of x/intent */
...
export interface GenesisStateAminoMsg {
  type: "/intento.intent.v1beta1.GenesisState";
...
export interface SequenceProtoMsg {
  typeUrl: "/intento.intent.v1beta1.Sequence";
  value: Uint8Array;
}
/** Sequence id and value of a counter */
...
export interface SequenceAminoMsg {
  type: "/intento.intent.v1beta1.Sequence";
  value: SequenceAmino;
}
/** Sequence id and value of a counter */
...
export const GenesisState = {
  ...
  encode(message: GenesisState, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    for (const v of message.actionInfos) {
      ActionInfo.encode(v!, writer.uint32(26).fork()).ldelim();
    }
