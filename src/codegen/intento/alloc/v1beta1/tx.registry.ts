...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/intento.alloc.v1beta1.MsgFundFairburnPool", MsgFundFairburnPool], ["/intento.alloc.v1beta1.MsgUpdateParams", MsgUpdateParams]];
